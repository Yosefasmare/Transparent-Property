...
export default function Footer() {
  return (
    <footer className="bg-primary-900 border-t border-primary-800 mt-12">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="font-medium text-xl text-white tracking-tight">Hulu House</span>
          </div>
          <p className="text-neutral-300 text-sm mb-4">we are ....</p>
        </div>
        {/* Quick Links */}
        <div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-base text-neutral-200">
            <li><span className="font-normal text-neutral-300">Email:</span> info@huluhouse.com</li>
      ...
      <div className="text-center text-neutral-300 text-xs py-5 border-t border-primary-800 bg-primary-900">© {new Date().getFullYear()} Hulu House. All rights reserved.</div>
    </footer>
  );
} 
...
const ContactPage = () => {
  ...
  const socialLinks = [
    { name: 'Facebook', icon: IoLogoFacebook, url: '#', color: 'hover:text-accent-600' },
    { name: 'Twitter', icon: IoLogoTwitter, url: '#', color: 'hover:text-accent-400' },
    { name: 'Instagram', icon: IoLogoInstagram, url: '#', color: 'hover:text-secondary-500' },
    { name: 'LinkedIn', icon: IoLogoLinkedin, url: '#', color: 'hover:text-accent-700' }
  ]
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="group bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-white/20">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-accent-500 to-accent-700 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white rounded-3xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 border border-neutral-100">
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-accent-50 to-primary-50 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300">
                    <feature.icon className="text-accent-600 text-2xl" />
                  </div>
                  <h3 className="text-lg font-semibold text-neutral-900 mb-3 group-hover:text-accent-600 transition-colors duration-300">{feature.title}</h3>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {departments.map((dept, index) => (
              ...
              >
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-neutral-900 mb-4 group-hover:text-accent-600 transition-colors duration-300">{dept.name}</h3>
                  <p className="text-neutral-600 mb-6 leading-relaxed">{dept.description}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8">
            ...
            <div className="group text-center">
              <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-accent-500 to-accent-700 rounded-full mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex items-center gap-6">
              {socialLinks.map((social, index) => (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`group p-4 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 border border-neutral-100 ${social.color}`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >

    ...
    <main className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-pink-50 pb-12">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 pt-6 sm:pt-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-medium text-gray-800 mb-2 sm:mb-3">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-2 w-full sm:w-auto">
                <select
                  ...
                  className="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-300 rounded-xl text-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
                >
              ...
              <select
                ...
                className="w-full sm:w-auto px-3 sm:px-4 py-2 border border-gray-300 rounded-xl text-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm"
              >
        ...
        {currentProperties.length === 0 ? (
          <div className="text-center py-20">
            <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <IoBookmark className="text-4xl text-gray-400" />
            </div>
            <h3 className="text-xl font-medium text-gray-700 mb-2">No Saved Properties</h3>
                ...
                >
                  ...
                  <div className={`relative ${viewMode === 'list' ? 'w-full sm:w-80 h-48 sm:h-64' : 'h-48 sm:h-64'}`}>
                    ...
                    <div className="absolute top-2 sm:top-4 right-2 sm:right-4 flex gap-1 sm:gap-2">
                      ...
                      <button className="bg-white/90 backdrop-blur-sm rounded-full p-1.5 sm:p-2 shadow-lg hover:bg-white transition-colors">
                        <FaShare className="text-gray-600 text-xs sm:text-sm" />
                      </button>
                      <button 
                  ...
                  <div className={`p-4 sm:p-6 flex-1 flex flex-col ${viewMode === 'list' ? 'ml-0' : ''}`}>
                    ...
                    <div className="flex items-center gap-2 text-gray-600 mb-3 sm:mb-4">
                      <FaMapMarkerAlt className="text-indigo-500 text-sm sm:text-base" />
                    ...
                    <div className="flex items-center gap-2 sm:gap-4 mb-3 sm:mb-4 text-xs sm:text-sm text-gray-600">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FaBed className="text-indigo-500 text-sm sm:text-base" />
                        <span>{property.beds} beds</span>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FaBath className="text-indigo-500 text-sm sm:text-base" />
                        <span>{property.baths} baths</span>
                      </div>
                      <div className="flex items-center gap-1 sm:gap-2">
                        <FaRulerCombined className="text-indigo-500 text-sm sm:text-base" />
                    ...
                    <div className="mt-auto flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="text-xs sm:text-sm text-gray-500">{formatViews(property.views)} views</div>
                      </div>
                    </div>
                    ...
                    <Link
                      ...
                      className="mt-3 sm:mt-4 w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-medium py-2.5 sm:py-3 px-3 sm:px-4 rounded-xl text-center hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 transform hover:scale-105 text-sm sm:text-base"
                    >
                      View Property
                    </Link>
                  </div>
        ...
        {properties.length === 0 && (
          <div className="text-center py-20">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">All Properties Removed</h3>
            <p className="text-gray-500 mb-6">You&apos;ve removed all your saved properties.</p>
            <Link
              href="/properties"
              className="inline-flex items-center gap-2 px-6 py-3 bg-indigo-600 text-white font-medium rounded-xl hover:bg-indigo-700 transition-colors"
            >
